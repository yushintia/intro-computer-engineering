# Introduction to Computer Engineering (400507-001)

Markdown-driven web slides for Introduction to Computer Engineering,
DEU 2026-2, built with [Marp](https://marp.app/), themed to match
`shintia-template.pptx`. Deployed via GitHub Pages, see
